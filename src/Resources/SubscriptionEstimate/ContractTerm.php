...
class ContractTerm  { 
    ...
    */
    ...
    /**
    *
    * @var ?\Chargebee\Resources\SubscriptionEstimate\ClassBasedEnums\ContractTermStatus $status
    */
    public ?\Chargebee\Resources\SubscriptionEstimate\ClassBasedEnums\ContractTermStatus $status;
    
    /**
    *
    * @var ?\Chargebee\Resources\SubscriptionEstimate\ClassBasedEnums\ContractTermActionAtTermEnd $action_at_term_end
    */
    public ?\Chargebee\Resources\SubscriptionEstimate\ClassBasedEnums\ContractTermActionAtTermEnd $action_at_term_end;
    ...
    */
    ...
    private function __construct(
        ...
        ?\Chargebee\Resources\SubscriptionEstimate\ClassBasedEnums\ContractTermStatus $status,
        ?\Chargebee\Resources\SubscriptionEstimate\ClassBasedEnums\ContractTermActionAtTermEnd $action_at_term_end,
    )
    { 
        $this->id = $id;
    ...
    { 
        ...
        isset($resourceAttributes['status']) ? \Chargebee\Resources\SubscriptionEstimate\ClassBasedEnums\ContractTermStatus::tryFromValue($resourceAttributes['status']) : null,
        
        isset($resourceAttributes['action_at_term_end']) ? \Chargebee\Resources\SubscriptionEstimate\ClassBasedEnums\ContractTermActionAtTermEnd::tryFromValue($resourceAttributes['action_at_term_end']) : null,
