...
class LineItemDiscount  { 
    ...
    */
    ...
    /**
    *
    * @var ?\Chargebee\Resources\Invoice\ClassBasedEnums\LineItemDiscountDiscountType $discount_type
    */
    public ?\Chargebee\Resources\Invoice\ClassBasedEnums\LineItemDiscountDiscountType $discount_type;
    ...
    */
    ...
    private function __construct(
        ...
        ?string $entity_id,
        ?int $discount_amount,
        ?\Chargebee\Resources\Invoice\ClassBasedEnums\LineItemDiscountDiscountType $discount_type,
    )
    { 
    ...
    { 
        ...
        isset($resourceAttributes['discount_type']) ? \Chargebee\Resources\Invoice\ClassBasedEnums\LineItemDiscountDiscountType::tryFromValue($resourceAttributes['discount_type']) : null,
