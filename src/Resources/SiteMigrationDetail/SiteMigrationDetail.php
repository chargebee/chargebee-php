...
class SiteMigrationDetail  { 
    ...
    */
    ...
    { 
        $returnData = new self( $resourceAttributes['entity_id'] ,
        $resourceAttributes['other_site_name'] ,
        $resourceAttributes['entity_id_at_other_site'] ,
        $resourceAttributes['migrated_at'] ,
