...
namespace Chargebee\Resources\QuotedRamp\ClassBasedEnums;
...
final class DiscountEntityType { 
    ...
    private static array $choices = [ "item_level_coupon","document_level_coupon","item_level_discount","document_level_discount", ];
