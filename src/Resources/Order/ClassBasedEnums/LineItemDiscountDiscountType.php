...
final class LineItemDiscountDiscountType { 
    ...
    private static array $choices = [ "item_level_coupon","document_level_coupon","promotional_credits","prorated_credits","custom_discount","item_level_discount","document_level_discount", ];
