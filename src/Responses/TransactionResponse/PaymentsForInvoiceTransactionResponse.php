...
class PaymentsForInvoiceTransactionResponse extends ResponseBase { 
    /**
    *
    * @var array<PaymentsForInvoiceTransactionResponseListObject> $list
    */
    public array $list;
    ...
    */
    ...
    {
            $list = array_map(function (array $result): PaymentsForInvoiceTransactionResponseListObject {
                return new PaymentsForInvoiceTransactionResponseListObject(
