...
'periodUnit', 'trialPeriod', 'trialPeriodUnit', 'pricingModel', 'chargeModel', 'freeQuantity','setupCost', 'downgradePenalty', 'status', 'archivedAt', 'billingCycles', 'redirectUrl', 'enabledInHostedPages','enabledInPortal', 'addonApplicability', 'taxCode', 'taxjarProductCode', 'avalaraSaleType','avalaraTransactionType', 'avalaraServiceType', 'sku', 'accountingCode', 'accountingCategory1','accountingCategory2', 'isShippable', 'shippingFrequencyPeriod', 'shippingFrequencyPeriodUnit','resourceVersion', 'updatedAt', 'giftable', 'claimUrl', 'invoiceNotes', 'taxable', 'taxProfileId','metaData', 'tiers', 'applicableAddons', 'attachedAddons', 'eventBasedAddons', 'showDescriptionInInvoices','showDescriptionInQuotes');
