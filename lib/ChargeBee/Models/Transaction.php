...
'description', 'type', 'date', 'currencyCode', 'amount', 'idAtGateway', 'status', 'initiatorType','threeDSecure', 'errorCode', 'errorText', 'voidedAt', 'voidDescription', 'amountUnused', 'maskedCardNumber','referenceTransactionId', 'refundedTxnId', 'reversalTransactionId', 'linkedInvoices', 'linkedRefunds');
