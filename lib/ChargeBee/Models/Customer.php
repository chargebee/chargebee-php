...
'allowDirectDebit', 'createdAt', 'createdFromIp', 'taxability', 'cardStatus', 'billingAddress','contacts', 'paymentMethod', 'invoiceNotes', 'accountCredits', 'refundableCredits', 'excessPayments');
  ...
  {
    return Request::send(Request::GET, Util::encodeURIPath("customers"), $params, $env, $headers);
  }
  ...
  {
    return Request::send(Request::POST, Util::encodeURIPath("customers",$id,"add_account_credits"), $params, $env, $headers);
  }

  public static function deductAccountCredits($id, $params, $env = null, $headers = array())
  {
    return Request::send(Request::POST, Util::encodeURIPath("customers",$id,"deduct_account_credits"), $params, $env, $headers);
  }

  public static function setAccountCredits($id, $params, $env = null, $headers = array())
  {
    return Request::send(Request::POST, Util::encodeURIPath("customers",$id,"set_account_credits"), $params, $env, $headers);
  }
